...
export function AdminPeople() {
  ...
  if (s.role !== "admin") return <Empty title="Administrator workspace">Switch to Administrator to review users and professional credentials.</Empty>;
...
export function AdminIssues() {
  const s = useWorkspace();
  const dispatch = useDispatch();
  if (s.role !== "admin") return <Empty title="Administrator workspace">Switch to Administrator to review payments and support requests.</Empty>;
