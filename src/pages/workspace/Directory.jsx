...
export function ProfessionalDetails() {
  ...
  const sessions = s.sessions.filter((x) => x.professionalId === id && x.date >= new Date().toLocaleDateString("en-CA"));
