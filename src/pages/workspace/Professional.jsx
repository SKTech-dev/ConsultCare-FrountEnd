...
export function Queue() {
  ...
  if (!["doctor", "lawyer"].includes(s.role)) return <Empty title="Professional workspace">Switch to a doctor or lawyer to view their independent queue.</Empty>;
